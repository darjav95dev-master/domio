...
/**
 * Error boundary for the contacto page.
 *
 * Catches rendering errors in the page (including the server component
 * tree and the ContactConfigForm) and shows a composed error state per
 * §8 of the design system: voice affirmative, no blame, border-left
 * accent 3px, retry button.
 *
 * @see design.md §8 (Error state)
 * @see tasks.md — T034
 */
export default function ContactConfigError({
  reset,
}: {
  error: Error;
  reset: () => void;
    ...
    >
      <div className="max-w-md border-l-[3px] border-accent-default pl-6">
        <h2 className="font-display text-xl font-medium leading-snug tracking-tight text-fg-default">
          No hemos podido cargar la configuración de contacto
        </h2>
        <p className="mt-2 text-base leading-relaxed text-fg-muted">
          Inténtalo de nuevo o contacta con nuestro equipo si el problema
          persiste.
        </p>
        <button
          type="button"
