...
/**
 * Error boundary for the block history page.
 *
 * Catches rendering errors in the block history tree and shows a
...
export default function BlockHistoryError({ reset }: ErrorPageProps) {
  return (
    <div
      role="alert"
      aria-live="polite"
    ...
    >
      <div className="max-w-md border-l-[3px] border-accent-default pl-6">
        <h2 className="font-display text-xl font-medium leading-snug tracking-tight text-fg-default">
          No hemos podido cargar el historial
        </h2>
        <p className="mt-2 font-sans text-base leading-relaxed text-fg-muted">
          Ocurrió un problema al cargar el historial de versiones. Inténtalo
          de nuevo o contacta con nuestro equipo si el problema persiste.
        </p>
        <button
          type="button"
          onClick={reset}
