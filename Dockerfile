...
# No es NEXT_PUBLIC_*, pero next.config.ts lo lee en build para images.remotePatterns.
ARG R2_PUBLIC_URL
# DSN del cliente (los DSN de Sentry son públicos por diseño) y versión del build.
